...
```mermaid
graph TD
    Player["Player Action & Proximity"] --> Stress["Sanity & Fear State Accumulator"]
    Stress --> Shader["Post-Processing Distortion Shaders"]
    Stress --> Audio["Dynamic Dynamic Ambience & Binaural Audio"]
    Stress --> AI["Enemy Aggression & Pathfinding Heuristic Shifts"]
```
